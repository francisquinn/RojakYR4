...
import kotlinx.android.synthetic.main.fragment_recording_page.view.*
 ...
 * Use the [RecordingPageFragment.newInstance] factory method to
...
class RecordingPageFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RecordingPageFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                RecordingPageFragment().apply {
